        ...
        <section className=" sm:px-8 py-[80px] overflow-hidden" id="about">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 py-6 place-items-center">
                ...
                >
                    ...
                    Greetings! I'm Abenet-MU, a passionate and dedicated web developer
                    with a flair for creating dynamic and user-friendly applications.
                    In my latest project, I've crafted a sleek and intuitive weather
                     app that provides real-time weather information with a modern
                      touch.
